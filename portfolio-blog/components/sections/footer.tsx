  ...
  return (
    <footer className="border-t-2 border-border bg-card">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              Ingeniero de Sistemas, Data Engineer & AI Engineer. Construyendo el futuro con datos,
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2 py-1.5 text-sm transition-colors hover:text-accent"
                >
        ...
        <div className="mt-6 border-t-2 border-border pt-6 text-center font-mono text-xs uppercase tracking-widest text-muted-foreground">
          &copy; {year} Andres Felipe Galeano Tellez. Todos los derechos
          reservados.
        </div>
      </div>
    </footer>
