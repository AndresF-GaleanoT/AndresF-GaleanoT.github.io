        ...
        <Reveal>
          <div className="relative border-2 border-foreground bg-card p-8 shadow-hard md:p-16 lg:p-20">
            ...
            <div className="relative">
              ...
              <h2 className="text-acid mt-6 text-balance text-4xl font-bold uppercase leading-[0.9] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
                Construyamos
                <br />
                algo increíble.
              </h2>
              <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">
                Estoy abierto a colaboraciones, proyectos desafiantes y
                oportunidades donde pueda aportar mis habilidades en ingeniería
                de datos, arquitectura de software e inteligencia artificial.
              </p>
