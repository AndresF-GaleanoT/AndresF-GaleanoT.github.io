...
export function Hero() {
  ...
  return (
    <section
      id="inicio"
      className="relative flex min-h-screen items-center overflow-hidden pt-24 grid-bg"
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 noise opacity-[0.06]"
      />
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 px-4 pb-20 sm:px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
        <motion.div
          variants={container}
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.div
            variants={item}
            className="mb-6 inline-flex items-center gap-2 border-2 border-border bg-card px-3 py-1.5 font-mono text-xs uppercase tracking-widest"
          >
          ...
          <motion.h1
            variants={item}
            className="text-acid glow-acid text-balance text-5xl font-bold uppercase leading-[0.9] tracking-tight sm:text-6xl md:text-7xl xl:text-8xl"
          >
            Andres Felipe
            <br />
            Galeano Tellez
          ...
          >
            {ROLES.map((role) => (
              <li
                key={role}
                className="border-2 border-border px-3 py-1.5 font-mono text-xs uppercase tracking-wide text-muted-foreground"
              >
                {role}
              </li>
            ))}
          ...
          >
            Construyo pipelines de datos, arquitecturas escalables y soluciones
        ...
        >
          <div className="relative border-2 border-foreground bg-card shadow-hard">
            ...
            <div className="relative aspect-square">
              <Image
                ...
                alt="Ilustración blueprint de una arquitectura de pipeline de datos"
                fill
                priority
            ...
            <div className="grid grid-cols-2 border-t-2 border-border font-mono text-[10px] uppercase tracking-widest text-muted-foreground sm:grid-cols-3">
              <span className="border-r-2 border-border px-3 py-2">Stack: Python</span>
              <span className="border-r-2 border-border px-3 py-2">Cloud: AWS</span>
